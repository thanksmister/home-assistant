...
**Home Assistant:** Il s'agit de l'installation la plus complète qui consiste à dédié une machine physique, ou virtuelle, à Home Assistant sous la forme d'un système d'exploitation<br/>
...
**Home Assistant Supervised:** Consiste à installer l'ensemble de la solution dans un système d'exploitation autre que celui développer à cette fin. À ce jour, seul Debian est supporté, et ainsi fortement recommandé<br/><br/>
